...
/**
 * Engine-side implementation of {@link MultiTableRowErrorHandler} that bridges multi-table sink
 * sub-writer errors into the shared {@link ErrorHandler}.
 *
 * <p>This mirrors the logic in {@link ErrorHandlingSinkWriter} so that row-level errors detected
 * inside {@link org.apache.seatunnel.api.sink.multitablesink.MultiTableSinkWriter} are classified
 * consistently and routed to the configured error sink instead of failing the whole job when
 * possible.
 */
@Slf4j
