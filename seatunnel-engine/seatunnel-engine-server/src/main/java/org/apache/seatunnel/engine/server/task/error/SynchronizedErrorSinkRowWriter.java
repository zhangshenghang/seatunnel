...
/**
 * Serialize {@link ErrorSinkRowWriter} calls.
 *
 * <p>The engine may call {@link ErrorSinkRowWriter#write(RowErrorContext, Object, Throwable)} from
 * different threads (for example, multi-table sink sub-writer threads). This wrapper guarantees
 * that {@code write(...)} and {@code close()} are never executed concurrently.
 */
