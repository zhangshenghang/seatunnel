...
public class CheckpointBarrierTriggerErrorTest extends AbstractSeaTunnelServerTest {
    ...
    public void testCheckpointBarrierTriggerError()
        ...
        // Set up the stub BEFORE injecting the spy into the running system to avoid a race
        // condition where the background checkpoint thread could call sendOperationToMemberNode
        // while Mockito is in the middle of configuring the stub, leading to UnfinishedStubbing.
