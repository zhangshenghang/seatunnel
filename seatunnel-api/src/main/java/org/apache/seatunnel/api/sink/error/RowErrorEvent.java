...
/**
 * A row-level error event reported by a sink connector.
 *
 * <p>This is designed for failures that happen outside {@code SinkWriter.write(row)}, for example
 * during internal flush / {@code prepareCommit} / {@code close}, where the engine otherwise has no
 * direct access to the rows involved in the failing batch.
 */
